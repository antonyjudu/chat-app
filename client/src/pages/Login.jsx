        ...
        <div className='flex flex-col gap-2'>
          {currentState === "Sign Up" ? (
            <p className='text-sm text-gray-600'>Already have an Account?
             <span onClick={()=> {setCurrentState("Login"); setIsDataSubmitted(false);}} className='font-medium text-violet-600 cursor-pointer'>
              {" "}Login here
              </span>
            </p>
          ) : (
            <p className='text-sm text-gray-600'>Create an Account 
              <span onClick={()=> setCurrentState("Sign Up")} className='font-medium text-violet-600 cursor-pointer'>
                {" "}Click here
              </span>
            </p>
          )}
